...
def main() -> int:
    ...
    require(
        ...
        has_all(
            "panels/strings/StringsPanel.tsx",
            "r().truncated",
            "cap-notice",
            "MAX_STRING_LIMIT",
            "partial result",
    ...
    require(
        ...
        has_all(
            "panels/taint/TaintPanel.tsx",
            "r().stopped",
            "cap-notice",
            "full dependency chain may continue",
            "MAX_TAINT_ROWS",
        ),
        failures,
    )
    require(
        ...
        has_all(
            "panels/calltree/CallTreePanel.tsx",
            "truncatedChildren() > 0",
            "cap-notice",
            "deeper child nodes are hidden",
        ),
        failures,
    )
    require(
        ...
        has_all(
            "panels/backtrace/BacktracePanel.tsx",
            "r().truncated",
            "cap-notice",
            "MAX_BACKTRACE_LIMIT",
            "showing the last",
    ...
    require(
        ...
        has_all(
            "panels/tracepc/TraceForPcPanel.tsx",
            "before_capped",
            "after_capped",
            "cap-notice",
            "MAX_TRACE_PC_LIMIT",
    ...
    require(
        ...
        has_all(
            "panels/memory/MemoryPanel.tsx",
            "ctx().writes?.truncated",
            "Write details stopped",
            "partial result",
        ),
        failures,
    )
