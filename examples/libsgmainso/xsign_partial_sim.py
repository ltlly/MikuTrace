...
- semantic offset 11 is no longer treated as an opaque trace literal: across
  diff samples it has an add32_mix state-high-byte source proof before the
  same parity XOR mask. Semantic offset 12 is now covered as low8(meta.callIdx)
  xor mask.
...
CALL001_SCRATCH_WRITER_REPLAY_WRITES = [
    ...
    },
    {
        ...
        "lineage_probe": {
            "command": (
                "tracemiku-cli byte-lineage <call_dir> --addr 0x74b68bbe0c "
                "--before-idx 14164505 --depth 120 --lookback 8000000 --compact"
            ),
            "steps_returned": 57,
            "recognized_semantic_count": 21,
            "head_formula": "0xb39301f6 = 0xb3000000 | (0x9301f641 >> 8)",
            "mid_formula": "0x9301f641 = 0xbfaa5a69 ^ 0x2cabac28",
            "terminal": "bytecode_read_boundary",
            "terminal_idx": 10613716,
            "terminal_asm": "ldr x1, [x21, #8]",
            "terminal_addr": "0x75ebae5ad8",
            "top_repeated_values": [
                {"value": "0x9301f641", "count": 13},
                {"value": "0xd37f54b4", "count": 8},
                {"value": "0x18", "count": 5},
                {"value": "0xbfaa5a69", "count": 5},
                {"value": "0x107d8", "count": 4},
                {"value": "0xf6", "count": 4},
            ],
        },
    },
    ...
    },
    {
        ...
        "lineage_probe": {
            "command": (
                "tracemiku-cli byte-lineage <call_dir> --addr 0x74b68bbe14 "
                "--before-idx 14164666 --depth 120 --lookback 8000000 --compact"
            ),
            "steps_returned": 57,
            "recognized_semantic_count": 21,
            "head_formula": "0xe39d02cc = 0xe3000000 | (0x9d02cc0c >> 8)",
            "mid_formula": "0x9d02cc0c = 0xb1a96024 ^ 0x2cabac28",
            "terminal": "bytecode_read_boundary",
            "terminal_idx": 10616493,
            "terminal_asm": "ldr x1, [x21, #8]",
            "terminal_addr": "0x75ebae5ad8",
            "top_repeated_values": [
                {"value": "0x9d02cc0c", "count": 13},
                {"value": "0x496352c0", "count": 8},
                {"value": "0xa", "count": 5},
                {"value": "0xb1a96024", "count": 5},
                {"value": "0x4433300a", "count": 4},
                {"value": "0xcc", "count": 4},
            ],
        },
    },
...
TRACE_MULTI_SAMPLE_XOR_HALFWORD_11_13 = {
    "diff_run1_truncated_call_006": {
        ...
        "state_add_lhs": 0xE6A626EE,
        "state_add_rhs": 0x8581017F,
        "state_add_result": 0x16C27286D,
        "counter_input": 0x66C,
        "counter_byte": 0x06,
    },
    "diff_run1_call_001": {
        ...
        "state_add_lhs": 0x2E657DF9,
        "state_add_rhs": 0x9F97230B,
        "state_add_result": 0xCDFCA104,
        "counter_input": 0x1CD,
        "counter_byte": 0x01,
    },
    "diff_run1_call_003": {
        ...
        "state_add_lhs": 0xBC7C1C4B,
        "state_add_rhs": 0xFBBCCA1D,
        "state_add_result": 0x1B838E668,
        "counter_input": 0x3B8,
        "counter_byte": 0x03,
    },
    "diff_run1_call_004": {
        ...
        "state_add_lhs": 0xBE7455DD,
        "state_add_rhs": 0x1CC90B7E,
        "state_add_result": 0xDB3D615B,
        "counter_input": 0x4DB,
        "counter_byte": 0x04,
    },
    "diff_run1_call_005": {
        ...
        "state_add_lhs": 0x4AB15934,
        "state_add_rhs": 0x674FB44B,
        "state_add_result": 0xB2010D7F,
        "counter_input": 0x5B2,
        "counter_byte": 0x05,
    },
}
...
TRACE_MULTI_SAMPLE_META_CALL_IDXS = {
    "diff_run1_truncated_call_006": 6,
    "diff_run1_call_001": 1,
    "diff_run1_call_003": 3,
    "diff_run1_call_004": 4,
    "diff_run1_call_005": 5,
}

TRACE_MULTI_SAMPLE_BYTECODE_LITERAL_63 = {
    "diff_run1_truncated_call_006": {
        "value": 0x03,
        "bytecode_read_idx": 6875400,
        "bytecode_addr": "0x74fbf74c78",
    },
    "diff_run1_call_001": {
        "value": 0x03,
        "bytecode_read_idx": 14155086,
        "bytecode_addr": "0x74fbf74c78",
    },
    "diff_run1_call_003": {
        "value": 0x03,
        "bytecode_read_idx": 6799589,
        "bytecode_addr": "0x74fbf74c78",
    },
    "diff_run1_call_004": {
        "value": 0x03,
        "bytecode_read_idx": 6779919,
        "bytecode_addr": "0x74fbf74c78",
    },
    "diff_run1_call_005": {
        "value": 0x03,
...
def multi_sample_formula_coverage(sample_tails: dict[str, bytes]) -> dict:
    ...
    for name, item in TRACE_MULTI_SAMPLE_XOR_HALFWORD_11_13.items():
        ...
        state_add_low32 = item["state_add_result"] & 0xFFFFFFFF
        tail_11_13.append(
            {
                "sample": name,
                ...
                "source_word_matches_state_add": state_add_low32 == item["state_word_be"],
                "counter_input": f"{item['counter_input']:#x}",
                "counter_byte": f"{item['counter_byte']:#x}",
            }
        )
    tail_12_call_idx_lane = []
    for name, call_idx in TRACE_MULTI_SAMPLE_META_CALL_IDXS.items():
        tail = sample_tails[name]
        lhs = call_idx & 0xFF
        rhs = tail[2]
        computed = xor_mix(lhs, rhs)
        tail_12_call_idx_lane.append(
            {
                "sample": name,
                "semantic_offset": 12,
                "call_idx": call_idx,
                ...
                "expected": f"{tail[12]:#x}",
                "matches": computed == tail[12],
            }
        )
    tail_61_65 = []
    ...
    for name, item in TRACE_MULTI_SAMPLE_BYTECODE_LITERAL_63.items():
        tail = sample_tails[name]
        lhs = item["value"] & 0xFF
        rhs = tail[1]
        computed = xor_mix(lhs, rhs)
    ...
    return {
        ...
        "formula_ranges": [
            ...
            {
                "semantic_offsets": [12],
                "kind": "call_idx_low_byte_xor_mask",
                "samples": sorted(TRACE_MULTI_SAMPLE_META_CALL_IDXS),
            },
        ],
        ...
        "partially_covered_semantic_offsets": sorted(
            set([62, 64] + middle_partial_offsets)
        ),
        ...
        "tail_11_13_all_samples_match": all(
            row["matches"] and row["source_word_matches_state_add"] for row in tail_11_13
        ),
        "tail_12_call_idx_lane": tail_12_call_idx_lane,
        "tail_12_call_idx_lane_all_samples_match": all(
            row["matches"] for row in tail_12_call_idx_lane
        ),
        ...
        "tail_63_bytecode_literal": tail_63_bytecode_literal,
        ...
        "partial_coverage_note": (
            ...
            "11 now has state-high-byte add32_mix source proof across the diff "
            "samples, while semantic offset 12 now matches low8(meta.callIdx) "
    ...
    return {
        ...
        "prompt_to_artifact_checklist": [
            {
                ...
                "artifacts": [
                    ...
                    "rust/target/debug/tracemiku-cli byte-lineage --compact --count",
                ...
                "evidence": [
                    "CLI reports VM replay steps, one-byte or batched byte lineage, semantic writer maps, and memory snapshots",
        ...
        "success_criteria": [
            ...
            },
            {
                ...
                "evidence": [
                    ...
                    "semantic offset 11 has add32_mix state-high-byte source proof across five diff samples",
        ...
        "blocking_gaps": [
            ...
            (
                ...
                "coverage, but 41 partial offsets still need portable source "
