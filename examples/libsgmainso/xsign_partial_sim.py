...
TRACE_CALL001_SCRATCH_TABLE_WRITER_CHAIN_SUMMARY = {
    "command": (
        ...
        "--vm-chain-runs 16 --vm-chain-follow-frontier --summary"
    ),
    ...
    "interpretation": (
        ...
        "first two runs consume stat('/').st_mtim.tv_sec, the middle runs "
        "mostly consume static memory constants through an XOR ladder, and "
    ...
    "runs": [
        ...
        },
        {
            ...
            "bytes_hex": "ecf29541",
            "writer_idx": 14164461,
            "source_class": "static_xor_ladder",
        ...
        },
        {
            ...
            "source_class": "static_xor_ladder",
            "first_static_addr": "0x7599191020",
            "static_values_hex": [
                "0xd37f54b4",
                "0x36fb2fcf",
                "0x496352c0",
