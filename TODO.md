...
- M3-diff-traces: `/api/diff-traces` + CLI wrapper ✅ 2026-05-04
...
- M3-jobj-history: `/api/jobj-history` + CLI wrapper ✅ 2026-05-04
- M3-jni-strings: `/api/jni-strings` + CLI wrapper ✅ 2026-05-04
- M3-field-at: `/api/field-at` + CLI fallback wrapper ✅ 2026-05-04
...
- M5 (next): LLIL flag-elim / `/api/llil/llm`
